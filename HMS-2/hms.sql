...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2023 at 09:44 AM
...
(77, 'Meeting for Navratri Celebration', 'Everyone are requested to attend the meeting as we have to discuss regarding navratri celebration', 0, '2023-10-27'),
(78, 'Meeting for Diwali Celebration ', 'meeting regarding diwali celebration', 0, '2023-10-27');
...
(3, 'Test', 'test@demo.com', 'demo', 'Changa', 254896536, '0000-00-00 00:00:00'),
(15, 'Parzi', 'parzi@email.com', '(parzi)', '', NULL, '2023-10-27 12:30:22');
...
--
ALTER TABLE `announcement`
  MODIFY `announcement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
